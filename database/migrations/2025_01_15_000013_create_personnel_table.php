...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('personnel', function (Blueprint $table) {
            ...
            $table->foreignId('sodoor_city_id')->nullable()->constrained('cities')->comment('شهر صدور شناسنامه');
            ...
            $table->foreignId('nationality_country_id')->nullable()->constrained('countries')->comment('کشور ملیت');
            ...
            $table->foreignId('country_id')->constrained('countries')->comment('کشور');
            $table->foreignId('province_id')->constrained('provinces')->comment('استان');
            $table->foreignId('city_id')->constrained('cities')->comment('شهر');
