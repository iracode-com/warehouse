...
@php
    ...
    $assets_in_public = get_latest_assets();
@endphp
...
>
    <head>
        ...
        @if($assets_in_public['css'])
            <link rel="stylesheet" href="{{ $assets_in_public['css'] }}">
        @endif

        @if($assets_in_public['css_theme'])
            <link rel="stylesheet" href="{{ $assets_in_public['css_theme'] }}">
        @endif
    ...
    >
        ...
        @if($assets_in_public['js'])
            <script src="{{ $assets_in_public['js'] }}"></script>
        @endif
